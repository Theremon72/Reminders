...
{
    /// <inheritdoc />
    public partial class AuditsInitial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_reminderAudits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_reminderAudits_Reminder_ReminderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_reminderAudits_ReminderId",
